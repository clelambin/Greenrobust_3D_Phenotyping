...
**Prerequisite:**
Some functions uses the modules OpenCV and Open3D, which are not installed in the python version within blender. To install it in Linux, run the following command:
